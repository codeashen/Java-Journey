package com.ashen.payb.service.consumer;

import com.ashen.common.constant.MqConst;
import com.ashen.common.utils.FastJsonConvertUtil;
import com.ashen.payb.dao.PlatformAccountMapper;
import com.ashen.payb.entity.PlatformAccount;
...
public class PayConsumer {
    ...
    class MessageListenerConcurrently4Pay implements MessageListenerConcurrently {
        ...
        public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
            ...
            try {
                System.err.println("---------------- pay b 收到支付成功消息 --------------");
