...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
									...
									<c:forEach items="${pageInfo.list}" var="order">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/order/findById?id=${order.id}'">详情</button>
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
								<c:forEach begin="${1}" end="${5}" var="pageSize">
									<c:if test="${pageInfo.pageSize == pageSize}">
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2017-2019 <a
				href="https://gitee.com/codeashen">CODEASHEN研究院</a>.
	...
	<script>
		function changePageSize() {
			...
			//向服务器发送请求，改变没页显示条数
			location.href = "${pageContext.request.contextPath}/order/findAll?page=1&size="
					+ pageSize;
		}
